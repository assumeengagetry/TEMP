    ...
    <div class="max-w-6xl mx-auto px-4 py-20">
      <div class="text-center">
        ...
        <div class="flex justify-center space-x-6 mb-12">
          <a href="https://github.com/assumeengagetry" target="_blank" class="text-gray-600 hover:text-gray-900 transition-colors">
          ...
          <a href="https://x.com/engageassume" target="_blank" class="text-gray-600 hover:text-blue-400 transition-colors">
            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
